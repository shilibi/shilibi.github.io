	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">房间列表</h1>
						<h1 class="page-subhead-line">你可以从这里看到详细房间信息</h1>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form role="form" action="${pageContext.request.contextPath}/updateRoom_emp.action" method="post">
