 ...
 <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="orderFood.action" class="active-menu"><i class="fa fa-dashboard "></i>点菜</a>
                    </li>
                     <li>
									...
									<tbody>
										<s:iterator value="foodList" var="food">
											<tr class="list-group-item-success">
												<td><s:property value="#food.foodId" /></td>
												<td><s:property value="#food.foodName" /></td>
												<td><s:property value="#food.foodPrice" /></td>
												<td><s:property value="#food.foodUnit" /></td>
												<td>
													<a 
													href="<s:url action="/Page/Console_food/addFoodSale.action">  
                   								 <s:param name="foodId" value="#food.foodId" /> 
               									  </s:url>"
													class="btn btn-info ">点菜</a> &nbsp;&nbsp;&nbsp;&nbsp; 
												</td>
											</tr>
										</s:iterator>
									</tbody>
