					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form role="form" action="${pageContext.request.contextPath}/addEmp.action" method="post">
									<div class="form-group">
										<label>员工姓名</label> <input class="form-control" type="text"  name="bmpName">
									</div>
									<div class="form-group">
										<label>性别</label>
									...
									<div class="form-group">
										<label>联系方式</label> <input class="form-control" type="text" name="empPhone">
									</div>
									<div class="form-group">
										<label>职位</label> <input class="form-control" type="text" name="empJob">
									</div>
									<div class="form-group">
										<label>部门</label>
										<select class="form-control" name="empDepart">
										  <option value="8888">御膳房</option>
										  <option value="6666">乾清宫</option>
										</select>
									</div>
