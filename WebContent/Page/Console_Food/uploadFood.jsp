		 ...
		 <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="index_food.jsp"><i class="fa fa-dashboard "></i>收入</a>
                    </li>
                    <li>
                        <a  href="orderFood.action"><i class="fa fa-dashboard "></i>点菜</a>
                    </li>
                     <li>
                        <a href="uploadFood.jsp" class="active-menu"><i class="fa fa-yelp "></i>审报菜品</a>
                      <li>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form role="form" action="${pageContext.request.contextPath}/addFoodWait.action" method="post">
									<div class="form-group">
										<label>菜品名</label> <input class="form-control" type="text"  name="foodName">
									</div>
									<div class="form-group">
										<label>价格</label> <input class="form-control" type="text"  name="foodPrice">
									</div>
									<div class="form-group">
										<label>单位</label> <input class="form-control" type="text" name="foodUnit">
									</div>
